...
export function SignupForm() {
    const [signupState, signupDispatch] = useActionState(signupUserAction, undefined);
            ...
            <CardContent>
                <div className="grid gap-4">
                    <Form action={signupDispatch} className="grid gap-4">
                        ...
                        {signupState?.errors?.username && <p className="text-red-500">{signupState.errors.username}</p>}
                        <div className="grid gap-2">
                            <Label htmlFor="email">Email</Label>
                            <Input id="email" type="email" name="email" placeholder="user@gatech.edu" required />
                        </div>
                        {signupState?.errors?.email && <p className="text-red-500">{signupState.errors.email}</p>}
                        <div className="grid gap-2">
                        ...
                        {signupState?.errors?.password && <p className="text-red-500">{signupState.errors.password}</p>}
                        <div className="grid gap-2">
                            <div className="flex items-center">
                        ...
                        {signupState?.errors?.ambiguous && <p className="text-red-500">{signupState.errors.ambiguous}</p>}
