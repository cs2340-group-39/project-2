...
export async function signupUserAction(prevState: any, formData: FormData): Promise<SignupActionState> {
    ...
    return {
        success: "Thank you for signing up. Please check your email for further instructions.",
    };
}
