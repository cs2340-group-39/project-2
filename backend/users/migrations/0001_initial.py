...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(name="BlacklistedToken", fields=[("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID"))]),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("spotify_access_token", models.CharField(blank=True, max_length=10000, null=True)),
                ("spotify_refresh_token", models.CharField(blank=True, max_length=10000, null=True)),
                ("spotify_access_token_expires_at", models.DateTimeField(blank=True, null=True)),
                ("user", models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name="profile_for_user", to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
